...
from experiments.climate.adapted_climateset_baselines.climax.climax_module import ClimaXConfig, ClimaX
from experiments.climate.adapted_climateset_baselines.unet import UNetConfig, UNet
from experiments.climate.adapted_climateset_baselines.cnn_lstm import CNNLSTMConfig, CNNLSTM_ClimateBench

import experiments.climate.persisted_configs.final_climate_pear_runs.train_climate_pear_multiseed as swin_baseline
import experiments.climate.persisted_configs.final_climateset_baseline_runs.train_climax_nohp_multiseed_latfix as climax
import experiments.climate.persisted_configs.final_climateset_baseline_runs.train_unet_nohp_multiseed_latfix as unet
import experiments.climate.persisted_configs.final_climateset_baseline_runs.train_cnn_lstm_nohp_multiseed_latfix as cnn_lstm
