...
from experiments.climate.persisted_configs.var_weighing.train_climate_pear_pr_weighing import (
...
N_EPOCHS = int(os.environ.get("N_EPOCHS", "350"))

PR_WEIGHINGS = [0.1, 0.3, 0.5, 0.6, 0.7, 0.8, 0.9]
