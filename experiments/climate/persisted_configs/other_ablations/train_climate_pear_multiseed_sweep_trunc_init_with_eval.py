"""
Sweep file for training SwinHPClimatesetTruncInit (alt Conv init) with multiple seeds
...
Usage:
    ...
    CLIMATE_MODEL_IDX=12 N_SEEDS=3 python run_slurm_sweep.py \
        experiments/climate/persisted_configs/train_climate_pear_multiseed_sweep_trunc_init_with_eval.py
...
from experiments.climate.persisted_configs.other_ablations.train_climate_pear_multiseed_initalt import (
    create_config,
    ClimatesetHPConfig,
    ClimatesetDataHP,
...
def run(config):
    ...
    mf.register(SwinHPClimatesetInitAltConfig, SwinHPClimatesetTruncInit)
