#!/usr/bin/env python
"""
Multi-seed training config for SwinHP (patch_size=4) on the ClimateSet HEALPix dataset.

Same as train_climate_pear_multiseed.py but with patch_size=4.
Seed (ensemble_id) only affects weight initialisation; the data split is fixed (random_seed=1).
"""
