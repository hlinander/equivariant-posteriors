"""
Ablation sweep for SwinHP (multiseed): embed_dims and output_vars.
...
from experiments.climate.persisted_configs.other_ablations.train_climate_pear_multiseed_4ps import (
    create_config as create_multiseed_config,
)
...
def create_configs():
    return get_config_grid(lambda **kw: {"_fn": create_multiseed_config, **kw}, dict(
