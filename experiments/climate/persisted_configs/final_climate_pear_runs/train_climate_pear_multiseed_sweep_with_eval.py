...
with post-training evaluation across checkpoints.

Usage:
    # 5 seeds on NorESM2-LM (climate model index 12):
    CLIMATE_MODEL_IDX=12 N_SEEDS=5 python run_slurm_sweep.py \
        experiments/climate/persisted_configs/train_climate_pear_multiseed_sweep_with_eval.py
"""
