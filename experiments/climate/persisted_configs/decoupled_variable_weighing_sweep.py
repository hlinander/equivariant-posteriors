...
from experiments.climate.persisted_configs.train_climate_pear_pr_weighted_multiseed import (
    CLIMATE_MODELS,
    NSIDE,
)
...
def run(config):
    ...
    print(
        ...
        f"decoupling={decoupling}), epochs={epochs} ==="
    )
    ...
    for epoch in epochs:
        print(
            ...
            f"decoupling={decoupling}] epoch {epoch}"
        )
