...
from experiments.climate.models.climate_pear_temporal_atn import SwinHPClimatesetTemporalAtnConfig
from experiments.climate.models.climate_pear_temporal_atn import SwinHPClimatesetTemporalAtn
...
def create_config(
    ensemble_id,
    epoch=400, # previous was 200, find previous runs
    batch_size=12,
    climate_model_idx=0,
    lr=2e-4 ,
    ...
    def loss_fn(output, batch):
        #print("Loss fn output shape:", output["logits_output"].shape)
        #print("Loss fn target shape:", batch["target"].shape)
    ...
    train_config = TrainConfig(
        ...
        model_config=SwinHPClimatesetTemporalAtnConfig(
            base_pix=12,
            nside=NSIDE,
            dev_mode=False,
            depths=depths,
