...
Corrected lat-weighted loss: weights are applied to the lat axis (dim -2)
instead of the lon axis (dim -1) as in train_climax_nohp_multiseed.py.

Usage:
    # Single climate model, 3 seeds (SLURM array 0-2):
    N_SEEDS=3 CLIMATE_MODEL_IDX=12 python run_slurm_sweep.py \
        experiments/climate/persisted_configs/train_climax_nohp_multiseed_latfix_sweep.py
"""
