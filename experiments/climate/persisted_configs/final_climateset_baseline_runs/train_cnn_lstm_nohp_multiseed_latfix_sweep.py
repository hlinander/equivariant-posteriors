"""
Sweep file for training CNN-LSTM (latfix) with multiple seeds across one or
more climate models, followed by automatic evaluation at every saved checkpoint.

Usage:
    # 3 seeds on NorESM2-LM (climate model index 12):
    CLIMATE_MODEL_IDX=12 N_SEEDS=3 python run_slurm_sweep.py \
        experiments/climate/persisted_configs/train_cnn_lstm_nohp_multiseed_latfix_sweep.py
...
from experiments.climate.persisted_configs.final_climateset_baseline_runs.train_cnn_lstm_nohp_multiseed_latfix import (
    create_config,
    ClimatesetConfig,
    ClimatesetData,
    CNNLSTMConfig,
