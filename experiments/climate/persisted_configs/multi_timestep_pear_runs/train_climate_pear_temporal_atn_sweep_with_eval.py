"""
Sweep file for training SwinHPClimatesetTemporalAtn with multiple seeds
...
Usage:
    ...
    python run_slurm_sweep.py \
        experiments/climate/persisted_configs/train_climate_pear_temporal_atn_sweep_with_eval.py
...
N_EPOCHS  = int(os.environ.get("N_EPOCHS",  "400"))
