...
from experiments.weather.masks.masks import load_mask_hp
...
class SwinHPPanguMask(nn.Module):
    ...
    def __init__(self, config: SwinHPPanguMaskConfig, data_spec: DataSpec, **kwargs):
        super().__init__()
