...
def create_config(ensemble_id, epoch=1000, dataset_years=10):
...
def create_configs():
    return [lambda eid=eid: create_config(eid) for eid in range(N_MEMBERS)]
...
if __name__ == "__main__":
    ...
    ensemble_config = create_ensemble_config(
        lambda eid: create_config(eid, dataset_years=dataset_years), N_MEMBERS
    )
