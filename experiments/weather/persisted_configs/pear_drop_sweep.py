...
from lib.ensemble import request_ensemble, request_train_run
...
def create_config(ensemble_id, epoch=200, dataset_years=10, drop_rate=0):
...
def create_configs():
    configs = [
        lambda: create_config(0, dataset_years=10) for drop_rate in [0, 0.05, 0.1, 0.2]
    ]
    return configs
